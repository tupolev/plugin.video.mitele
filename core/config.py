...
print "mitele.core.config PLATFORM_NAME="+PLATFORM_NAME
...
def verify_directories_created():
    import logger
    import os
    logger.info("mitele.core.config.verify_directories_created")
...
print "mitele.core.config runtime path = "+get_runtime_path()
print "mitele.core.config data path = "+get_data_path()
print "mitele.core.config temp path = "+get_temp_file("test")